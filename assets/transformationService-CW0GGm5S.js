const c=["OrderId","CustomerId","OrderDate","TotalAmount","Status","customer_id","first_name","last_name","email","phone","id","product_code","quantity","price","last_updated"],l=["Filter","Map","Aggregation","Script","Trim","Case Convert","Substring","Replace","Split"],i={name_asc:(t,e)=>t.name.localeCompare(e.name),name_desc:(t,e)=>e.name.localeCompare(t.name),type_asc:(t,e)=>t.type.localeCompare(e.type),created_desc:(t,e)=>new Date(e.createdAt)-new Date(t.createdAt),created_asc:(t,e)=>new Date(t.createdAt)-new Date(e.createdAt)},o=[{id:"1",name:"Equals Filter",type:"Filter",description:"Filter rows where a field equals a specific value",createdAt:new Date(Date.now()-30*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:["Sales Data ETL","Customer Import"],config:{operator:"equals",defaultValue:"Completed"}},{id:"2",name:"High Value Filter",type:"Filter",description:"Filter rows where a numeric field is greater than 1000",createdAt:new Date(Date.now()-28*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:[],config:{operator:"greaterThan",defaultValue:"1000"}},{id:"3",name:"Status Code Mapper",type:"Map",description:"Maps single-letter status codes to full names",createdAt:new Date(Date.now()-25*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:["Sales Data ETL"],config:{mappings:[{from:"P",to:"Pending"},{from:"C",to:"Completed"},{from:"X",to:"Cancelled"},{from:"R",to:"Refunded"}]}},{id:"4",name:"Sum Aggregation",type:"Aggregation",description:"Calculates sum of values grouped by specified fields",createdAt:new Date(Date.now()-20*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:["Customer Import"],config:{aggregationType:"sum",resultColumnName:"total"}},{id:"5",name:"Count Aggregation",type:"Aggregation",description:"Counts rows grouped by specified fields",createdAt:new Date(Date.now()-18*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:[],config:{aggregationType:"count",resultColumnName:"count"}},{id:"6",name:"Phone Number Formatter",type:"Script",description:"Formats phone numbers to (XXX) XXX-XXXX pattern",createdAt:new Date(Date.now()-15*24*60*60*1e3).toISOString(),dataSourceId:null,dataSourceName:null,usedInPipelines:["Customer Import"],config:{scriptLanguage:"javascript",script:`// Format phone numbers to (XXX) XXX-XXXX
if (row.phone) {
